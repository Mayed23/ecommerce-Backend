...
El "productManager" es fundamental en nuestro proyecto, aquí se lleva a cabo la lógica esencial para manipular la información que se transmite entre el cliente y el servidor. En esta fase, nos ocupamos de las operaciones CRUD (Crear, Leer, Actualizar, Borrar ó Eliminar). Gestionamos la conexión con el método de persistencia de datos, optando en este caso por el sistema de archivos (File System), que nos brinda la capacidad de manejar información en formato de texto plano.
